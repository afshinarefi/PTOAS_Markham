//ptoas --pto-arch=a5 --pto-backend=vpto --emit-vpto --tile-lib-backend=ptodsl --pto-level=level2 --enable-op-fusion --enable-fusion-version-selection --mlir-print-ir-after-all TMulTAdd_VersionSelection.mlir &> result.mlir
