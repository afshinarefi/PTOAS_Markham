//ptoas --pto-arch=a5 --pto-backend=vpto --emit-vpto --tile-lib-backend=ptodsl --pto-level=level2 --enable-op-fusion --enable-fusion-version-selection --mlir-print-ir-after-all TMulTAdd_2DSelection.mlir &> result.mlir

module attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
  func.func @TMulTAdd() {
    %add_b = pto.alloc_tile
      : !pto.tile_buf<loc=vec, dtype=f32, rows=32, cols=128, v_row=16, v_col=64,
